...
var selectContactSchema = createSelectSchema(contacts);
...
async function registerRoutes(app2) {
  ...
  app2.patch("/api/admin/contacts/:id/read", async (req, res) => {
    try {
  ...
  app2.get("/api/admin/contacts/unread-count", async (req, res) => {
    try {
